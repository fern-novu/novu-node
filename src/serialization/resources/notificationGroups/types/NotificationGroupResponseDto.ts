...
export const NotificationGroupResponseDto: core.serialization.ObjectSchema<
    serializers.NotificationGroupResponseDto.Raw,
...
export declare namespace NotificationGroupResponseDto {
    interface Raw {
        _id?: string | null;
        name: string;
